...
import 'package:frontend/common/playButton.dart';
import 'package:provider/provider.dart';
import 'package:video_player/video_player.dart';

class SubspaceControls extends StatefulWidget {
  const SubspaceControls({
  ...
  State<StatefulWidget> createState() {
    return _SubspaceControlsState();
  }
}

class _SubspaceControlsState extends State<SubspaceControls>
